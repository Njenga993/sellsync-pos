    ...
    <div style="padding:0 0 20px">
        <div style="max-width:580px;margin:0 auto;padding:0 16px">
            ...
            <div class="info-bar">
                ...
                Editing: <strong>{{ $customer->name }}</strong>
                · Spent: <strong>KES {{ number_format($customer->total_spent, 2) }}</strong>
                · Points: <strong>{{ number_format($customer->loyalty_points) }} pts</strong>
            </div>
            ...
            <div class="form-panel">
                <form method="POST" action="{{ route('customers.update', $customer) }}">
                    ...
                    <div class="grid-2">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="credit_limit">Credit Limit (KES)</label>
                            <input id="credit_limit" name="credit_limit" type="number" step="0.01" class="form-input"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="address" name="address" rows="2" class="form-textarea">{{ old('address', $customer->address) }}</textarea>
                    </div>
