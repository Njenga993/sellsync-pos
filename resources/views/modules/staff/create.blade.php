                ...
                <form method="POST" action="{{ route('staff.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="name" name="name" type="text" class="form-input"
                            value="{{ old('name') }}" placeholder="e.g. John Kamau" required />
                        @if($errors->has('name'))
                    ...
                    <div class="grid-2">
                        <div class="form-group">
                            ...
                            <input id="email" name="email" type="email" class="form-input"
                                value="{{ old('email') }}" placeholder="john@business.com" required />
                            @if($errors->has('email'))
                    ...
                    <div class="grid-2">
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('branch_id'))
                                <div class="error-msg">{{ $errors->first('branch_id') }}</div>
                            @endif
                        </div>
                    </div>

                    <div class="section-title" style="margin-top:4px">Security</div>
                    ...
                    <div class="grid-2" style="margin-bottom:20px">
                        ...
                        <div class="form-group">
                            ...
                            <input id="password_confirmation" name="password_confirmation"
                                type="password" class="form-input" placeholder="Re-enter password" required />
                        </div>
                    </div>
