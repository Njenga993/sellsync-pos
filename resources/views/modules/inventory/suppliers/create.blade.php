<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-semibold text-gray-800">Add Supplier</h2>
        </div>
    </x-slot>
                ...
                <form method="POST" action="{{ route('suppliers.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="name" name="name" type="text"
                            ...
                            placeholder="e.g. Unga Group Ltd" required />
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <x-text-input id="contact_person" name="contact_person" type="text"
                                class="block mt-1 w-full" :value="old('contact_person')"
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="city" name="city" type="text"
                                class="block mt-1 w-full" :value="old('city')"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="address" name="address" rows="2"
                            class="block mt-1 w-full border-gray-300 rounded-md shadow-sm text-sm">{{ old('address') }}</textarea>
                    </div>
