    ...
    <div style="padding:0 0 20px">
        <div style="max-width:620px;margin:0 auto;padding:0 16px">
            ...
            <div class="info-bar">
                ...
                Editing: <strong>{{ $supplier->name }}</strong>
                @if($supplier->city)
                    · {{ $supplier->city }}
                @endif
                · <strong>{{ $supplier->purchase_orders_count }} POs</strong>
            </div>
            ...
            <div class="form-panel">
                <form method="POST" action="{{ route('suppliers.update', $supplier) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="address" name="address" rows="2" class="form-textarea">{{ old('address', $supplier->address) }}</textarea>
                    </div>
